...
public class FreeCam : MonoBehaviour
{
    ...
    [SerializeField] private HeightMapController heightmapComputeController;
    ...
    void Update()
    {
        ...
        {
            if (Physics.Raycast(_cam.transform.position, _cam.transform.forward, out var hitInfo, 100f))
            {
